...
def findpoints(raw, dataframe, buffer, poly, window, thresh, mindist, xstart, xend):
    ...
    ten = findP(peaks, basepoints, frontpoints,
                dataframe['disp'], dataframe['time'], .10)
    fifty = findP(peaks, basepoints, frontpoints,
                  dataframe['disp'], dataframe['time'], .50)
    eighty = findP(peaks, basepoints, frontpoints,
                   dataframe['disp'], dataframe['time'], .20)
    ninety = findP(peaks, basepoints, frontpoints,
                   dataframe['disp'], dataframe['time'], .90)
